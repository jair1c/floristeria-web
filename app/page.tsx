      ...
      <main>
        <section className="section-container grid gap-10 py-12 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:py-20">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg text-neutral-600">
              Crea una experiencia especial con ramos, box florales y regalos cuidadosamente presentados. Gestiona tu catálogo floral con una tienda elegante, rápida y lista para crecer con base de datos real.
            </p>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              <div className="card p-4">
                ...
                <p className="text-sm text-neutral-600">Panel privado protegido</p>
              </div>
              <div className="card p-4">
                <p className="text-2xl font-bold">Fase 3</p>
                <p className="text-sm text-neutral-600">Lista para Supabase</p>
              </div>
              <div className="card p-4">
                <p className="text-2xl font-bold">Escalable</p>
                <p className="text-sm text-neutral-600">Imágenes y datos reales</p>
              </div>
            </div>
          </div>
        ...
        <section className="section-container py-10">
          <div className="mb-8 flex items-end justify-between gap-4">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-roseBrand">Categorías</p>
              <h2 className="mt-2 text-3xl font-bold">Explora por ocasión</h2>
            </div>
            <Link href="/productos" className="inline-flex items-center gap-2 text-sm font-semibold text-roseBrand">
              Ver todas <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {categories.map((category) => (
              <Link key={category.slug} href={`/categoria/${category.slug}`} className="card overflow-hidden">
        ...
        <section className="section-container py-10">
          <div className="mb-8">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-roseBrand">Productos destacados</p>
              ...
              <article key={product.id} className="card overflow-hidden">
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 flex items-center justify-between gap-3">
                    ...
                    <a href="https://wa.me/51999999999" className="btn-secondary px-4 py-2 text-sm">
                      Pedir
                    </a>
                  </div>
                </div>
        ...
        <section className="section-container py-10">
          <div className="card grid gap-8 p-8 lg:grid-cols-[.95fr_1.05fr] lg:p-10">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-roseBrand">¿Por qué elegirnos?</p>
              <h2 className="mt-2 text-3xl font-bold">Una experiencia floral cuidada de principio a fin</h2>
        ...
        <section className="section-container py-10">
          <div className="mb-8">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-roseBrand">Testimonios</p>
